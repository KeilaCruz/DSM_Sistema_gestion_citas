...
import { createPacientes, updatePacientes, deletePacientes, getAllPacientes, getPacientes } from '../api/paciente.api'
        ...
        async function loadPaciente() {
            if (idPaciente) {
                const { data: { nombre, apePaterno, apeMaterno, edad, estado_civil, CURP, escolaridad, colonia, calle,
                    ...
                    ultima_visita_medico, numero_personas_vive } } = await getPacientes(idPaciente)
