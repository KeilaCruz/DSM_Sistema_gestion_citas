...
export function AddCita() {
    ...
    const handleSelectPaciente = (evt) => {
            ...
            <div className="container-fluid">
                <div className="row g-3 mt-5">
                    ...
                    <div className="col-md-2 mt-5">
                        <button onClick={handleBusquedaPaciente} className="button-buscar">Buscar</button>
                    </div>
                </div>
                            ...
                            <tbody>
                                {pacienteResultado.map(paciente => (
                                    <tr key={paciente.CURP}>
                                        <td className="fila">
                                            <input id="select_paciente" name="select_paciente" type="radio" value={paciente.CURP} onChange={handleSelectPaciente} />
                                        </td>
