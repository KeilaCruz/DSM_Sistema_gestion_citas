                    ...
                    <div>
                        <div className="row">
                            <div className="col-md-6 offset-1">
                                <input className="form-control" id="barra_busqueda" type="text" placeholder="Buscar por CURP o nombre" onChange={handleBarraChange} />
                            </div>
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="row g-3">
                            <div className="col-md-3 offset-1">
                                <label htmlFor="num_expediente" className="form-label">Número expediente</label>
                                <input className="form-control" id="num_expediente" placeholder="Número expediente" type="number" {...register("num_expediente", { required: true })} />
                            </div>

                            <div className="col-md-3">
                                <label htmlFor="fecha_nacimiento" className="form-label">Fecha de nacimiento</label>
                                <input className="form-control" type="date" id="fecha_nacimiento" placeholder="Fecha de nacimiento" {...register("fecha_nacimiento", { required: true })} />
                            </div>
                            <div className="col-md-4">
                                <label htmlFor="municipio_nacimiento" className="form-label">Municipio de nacimiento</label>
                                <input className="form-control" type="text" id="municipio_nacimiento" placeholder="Municipio de nacimiento" {...register("municipio_nacimiento", { required: true })} />
                            </div>
                            <div className="col-md-3 offset-1">
                                <label htmlFor="estado_nacimiento" className="form-label label-form">Estado de nacimiento</label>
                                <input className="form-control" type="text" id="estado_nacimiento" placeholder="Estado de nacimiento" {...register("estado_nacimiento", { required: true })} />
                            </div>
                            <div className="col-md-7">
                                <label htmlFor="motivo_consulta" className="form-label">Motivo de consulta</label>
                                <textarea id="motivo_consulta" className="form-control" placeholder="Motivo de consulta" {...register("motivo_consulta", { required: true })}></textarea>
                            </div>
                            ...
                            <div className="col-md-9 offset-1">
                                <label htmlFor="Indicadores_clinicos" className="form-label">Indicadores clínicos</label>
                            </div>
                            <div className="col-md-9 offset-1">
                                <label htmlFor="AHF" className="form-label">AHF</label>
                            </div>
                            ...
                            <div className="col-md-6 offset-1">
                                <input id="quien_diabetes" className="form-control" type="text" placeholder="¿Quién?" {...register("quien_diabetes", { required: true })} />
                            </div>
                            <div className="col-md-3 offset-1">
                                <label htmlFor="hipetension" className="form-label">Hipertensión</label>
                                <label className="form-check-label mx-4">Si
                            ...
                            <div className="col-md-3 offset-1">
                                <label htmlFor="Dislipidemias" className="form-label">Dislipidemias</label>
                                <label className="form-check-label mx-4">Si
                            ...
                            <div className="col-md-9 offset-1">
                                <label htmlFor="antecedentes_patologicos" className="title-secondary form-label">Antecedentes patológicos</label>
                            </div>
                            <div className="col-md-3 offset-1">
                                <label htmlFor="diabetes_mellitus" className="form-label">Diabetes mellitus</label>
