            ...
            <div className="container-fluid">
                ...
                <form onSubmit={onSubmit} className="row g-3">
                    ...
                    <div className="col-md-4 offset-md-1">
                        ...
                        <input id="fecha_registro" type="date" className="form-control input-form" {...register("fecha_registro", { required: true })} />
                    </div>
                    <div className="col-md-4 offset-md-1">
                    ...
                    {isMasculino && (
                        <div className="row g-3">
                            ...
                            <div className="col-md-4 offset-md-1">
                                ...
                                <input id="quien_dio_info" className="form-control input-form" type="text" placeholder="¿Quién le proporciono esa información?" {...register("quien_dio_info")} />
                            </div>
                            <div className="col-md-4 offset-md-1">
